...
databaseChangeLog = {
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "1683184030211-2") {
        ...
        sql("alter table AUDIT_LOG  add IS_FIRST_ENTRY_IN_TRANSACTION BOOLEAN;")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "1683184030212-8") {
        ...
        ADD COLUMN SECTION_CHILD_MODULE BOOLEAN DEFAULT FALSE;
    """)
        sql("update AUDIT_LOG  set SECTION_CHILD_MODULE = FALSE where SECTION_CHILD_MODULE is null;")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "1683184030212-9") {
        ...
        sql("alter table TEMPLT_QUERY  add PARAMETER_VALUE_AUDIT_STRING VARCHAR(32000);")
    }
    ...
    changeSet(author: "Yogesh (generated)", id: "1689569106455-2") {
        ...
        sql("alter table PVUSER  add USER_ROLES_STRING VARCHAR(32000);")
    }
    ...
    changeSet(author: "Yogesh (generated)", id: "1689569106455-5") {
        ...
        sql("alter table PVUSER  add SIGNAL_PIN_CONFIGS VARCHAR(8000);")
    }
    ...
    changeSet(author: "Yogesh (generated)", id: "1689569106455-6") {
        ...
        sql("alter table PVUSER  add USER_PIN_CONFIGS VARCHAR(8000);")
    }
    ...
    changeSet(author: "Uddesh (generated)", id: "16895691064313-1") {
        ...
        sql("alter table AUDIT_LOG add TMPDESCRIPTION TEXT;")
    ...
    changeSet(author: "Uddesh (generated)", id: "16895691064313-2") {
        ...
        sql("alter table AUDIT_LOG add TMP_ENTITY_VALUE TEXT;")
