databaseChangeLog = {
    changeSet(author: "Amrendra (generated)", id: "2097654321340-1") {
        ...
        sql("alter table SINGLE_ALERT_PAT_MED_HIST ALTER COLUMN SCA_PAT_MED_HIST TYPE VARCHAR(3000 );")
    }
    ...
    changeSet(author: "Amrendra (generated)", id: "2097654321340-2") {
        ...
        sql("alter table AR_SIN_ALERT_PAT_MED_HIST ALTER COLUMN SCA_PAT_MED_HIST TYPE VARCHAR(3000 );")
    }
    ...
    changeSet(author: "Amrendra (generated)", id: "2097654321340-3") {
        ...
        sql("alter table SINGLE_DEMAND_PAT_MED_HIST ALTER COLUMN SCA_PAT_MED_HIST TYPE VARCHAR(3000 );")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "202403191628-1") {
        ...
        sql("alter table LITERATURE_ACTIVITY add DETAILS1 TEXT")
