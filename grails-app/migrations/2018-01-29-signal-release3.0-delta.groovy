databaseChangeLog = {
    ...
    changeSet(author: "chetansharma (generated)", id: "1517200204498-111") {
        addColumn(tableName: "PREFERENCE") {
            column(defaultValueBoolean: "true", name: "is_cumulative_alert_enabled", type: "boolean") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1517200204498-365") {
        dropNotNullConstraint(columnDataType: "varchar(80)", columnName: "SOURCE_COLUMN_MASTER_ID", tableName: "RPT_FIELD")
    }
