...
databaseChangeLog = {
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-81") {
        addColumn(tableName: "DISPOSITION") {
            column(name: "abbreviation", type: "VARCHAR(3 )", defaultValue: "NA") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-146") {
        addColumn(tableName: "GROUPS") {
            column(name: "group_type", type: "VARCHAR(255 )", defaultValue: "USER_GROUP") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-156") {
        addColumn(tableName: "BUSINESS_CONFIGURATION") {
            column(name: "is_global_rule", type: "boolean", defaultValueBoolean: 'false') {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-161") {
        addColumn(tableName: "EVDAS_ALERT") {
            column(name: "listedness", type: "boolean", defaultValueBoolean: 'false') {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-174") {
        addColumn(tableName: "QUERY_VALUE") {
            column(name: "query_name", type: "VARCHAR(255 )", defaultValue: '') {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-183") {
        addColumn(tableName: "DISPOSITION") {
            column(name: "review_completed", type: "boolean", defaultValueBoolean: 'false') {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-3481") {
    ...
    changeSet(author: "APE (generated)", id: "1552389595224-428") {
        dropDefaultValue(columnDataType: "boolean", columnName: "is_cumulative_alert_enabled", tableName: "PREFERENCE")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-429") {
        dropDefaultValue(columnDataType: "boolean", columnName: "is_email_enabled", tableName: "PREFERENCE")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-430") {
        dropNotNullConstraint(columnDataType: "varchar(255)", columnName: "listed", tableName: "AGG_ALERT")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-431") {
        dropNotNullConstraint(columnDataType: "varchar(255)", columnName: "positive_dechallenge", tableName: "AGG_ALERT")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-432") {
        dropNotNullConstraint(columnDataType: "varchar(255)", columnName: "positive_rechallenge", tableName: "AGG_ALERT")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-433") {
        dropNotNullConstraint(columnDataType: "varchar(255)", columnName: "pregenency", tableName: "AGG_ALERT")
    }

    changeSet(author: "APE (generated)", id: "1552389595224-434") {
        dropNotNullConstraint(columnDataType: "varchar(255)", columnName: "related", tableName: "AGG_ALERT")
    }
