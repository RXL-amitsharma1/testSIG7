databaseChangeLog = {
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-43") {
        createTable(tableName: "EVDAS_ALERT") {
            ...
            column(name: "new_abuse", type: "VARCHAR(255 )")

            column(name: "new_ct", type: "VARCHAR(255 )")
            ...
            column(name: "new_occup", type: "VARCHAR(255 )")

            column(name: "new_paed", type: "VARCHAR(255 )")

            column(name: "new_rc", type: "VARCHAR(255 )")

            column(name: "new_roa1", type: "VARCHAR(255 )")

            column(name: "new_serious", type: "NUMBER(10, 0)")

            column(name: "new_spon", type: "VARCHAR(255 )")
            ...
            column(name: "roa1", type: "VARCHAR(255 )")
            ...
            column(name: "tot_abuse", type: "VARCHAR(255 )")

            column(name: "tot_ct", type: "VARCHAR(255 )")
            ...
            column(name: "tot_occup", type: "VARCHAR(255 )")

            column(name: "tot_paed", type: "VARCHAR(255 )")

            column(name: "tot_rc", type: "VARCHAR(255 )")

            column(name: "tot_roa1", type: "VARCHAR(255 )")

            column(name: "tot_spon", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-90") {
        createTable(tableName: "PREFERENCE") {
            ...
            column(defaultValueComputed: 1, name: "is_cumulative_alert_enabled", type: "boolean") {
                constraints(nullable: "false")
            }

            column(defaultValueComputed: 1, name: "is_email_enabled", type: "boolean") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-127") {
        createTable(tableName: "SOURCE_TABLE_MASTER") {
            ...
            column(name: "TABLE_ALIAS", type: "VARCHAR(5 )") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-136") {
        createTable(tableName: "SUPER_QUERY") {
            ...
            column(name: "HAS_BLANKS", type: "boolean") {
                constraints(nullable: "false")
            }
            ...
            column(name: "IS_EUDRA_QUERY", type: "boolean") {
                constraints(nullable: "false")
            }
            ...
            column(name: "NON_VALID_CASES", type: "boolean") {
                constraints(nullable: "false")
            }
            ...
            column(name: "QUERY_TYPE", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-213") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "EX_CUSTOM_SQL_QUERYPK", tableName: "EX_CUSTOM_SQL_QUERY")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-217") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "EX_QUERYPK", tableName: "EX_QUERY")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-219") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "EX_QUERY_SETPK", tableName: "EX_QUERY_SET")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-226") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "QUERYPK", tableName: "QUERY")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-228") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "QUERY_SETPK", tableName: "QUERY_SET")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-233") {
        ...
        addPrimaryKey(columnNames: "id", constraintName: "SQL_QUERYPK", tableName: "SQL_QUERY")
    }
...
//    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1527527772654-5321") {
