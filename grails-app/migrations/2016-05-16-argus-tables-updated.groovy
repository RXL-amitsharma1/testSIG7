databaseChangeLog = {
	...
	changeSet(author: "chetansharma (generated)", id: "1463396688844-10") {
		addColumn(tableName: "RPT_FIELD") {
			column(name: "ISAUTOCOMPLETE", type: "boolean", defaultValueBoolean: "false") {
				constraints(nullable: "false")
			}
		}
	}
	...
	changeSet(author: "chetansharma (generated)", id: "1463396688844-14") {
		...
		addNotNullConstraint(tableName: "RPT_FIELD", columnName: "RPT_FIELD_GRPNAME", columnDataType: "VARCHAR(255 )")
	}
