databaseChangeLog = {
    ...
    changeSet(author: "nikhilkhari (generated)", id: "1473245678582-471") {
        ...
        createTable(tableName: "ALERT_PRE_EXECUTION_CHK") {
            ...
            column(name: "IS_PVR_CHK_ENABLED", type: "boolean") {
                constraints(nullable: "false")
            }

            column(name: "IS_VER_ASOF_CHK_ENABLED", type: "boolean") {
                constraints(nullable: "false")
            }

            column(name: "IS_ETL_FAIL_CHK_ENABLED", type: "boolean") {
                constraints(nullable: "false")
            }


            column(name: "IS_ETL_INPROG_CHK_ENABLED", type: "boolean") {
                constraints(nullable: "false")
            }

            column(name: "IS_ENABLED_FOR_MASTER_CFG", type: "boolean") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "417223456762-467") {
        ...
        createTable(tableName: "ALERT_PRE_CHECK_HISTORY") {
            ...
            column(name: "pvr_check_updated", type: "boolean") {
                constraints(nullable: "false")
            }
            column(name: "new_pvr_check_val", type: "boolean") {
                constraints(nullable: "true")
            }


            column(name: "ver_asof_check_updated", type: "boolean") {
                constraints(nullable: "false")
            }
            column(name: "new_ver_asof_check_val", type: "boolean") {
                constraints(nullable: "true")
            }

            column(name: "etl_fail_check_updated", type: "boolean") {
                constraints(nullable: "false")
            }
            column(name: "new_etl_fail_check_val", type: "boolean") {
                constraints(nullable: "true")
            }

            column(name: "etl_in_prog_check_updated", type: "boolean") {
                constraints(nullable: "false")
            }
            column(name: "new_etl_in_prog_check", type: "boolean") {
                constraints(nullable: "true")
            }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "14725098756987-47") {
        ...
        createTable(tableName: "AUTO_ADJUSTMENT_RULE") {
            ...
            column(name: "adjustment_type_enum", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "417223243567-437") {
        ...
        createTable(tableName: "AUTO_ADJUSTMENT_HISTORY") {
            ...
            column(name: "adjustment_enum_updated", type: "boolean") {
                constraints(nullable: "false")
            }
            column(name: "old_adjustment_enum_value", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }

            column(name: "new_adjustment_enum_value", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }

            column(name: "is_enabled_flag_updated", type: "boolean") {
                constraints(nullable: "false")
            }


            column(name: "new_enabled_flag_value", type: "boolean") {
                constraints(nullable: "true")
            }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "23231232382-47") {
        ...
        createTable(tableName: "SKIPPED_ALERT_INFORMATION") {
            ...
            column(name: "STATE_ENUM", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
            column(name: "GROUP_CODE", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
            column(name: "ALERT_DISABLE_REASON", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
            column(name: "CREATED_BY", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
...
// New columns added in configuration table
    ...
    changeSet(author: "nikhilkhari (generated)", id: "14654612570-471") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "IS_AUTO_PAUSED", type: "boolean", defaultValueBoolean: "false") {
                constraints(nullable: true)
            }
        }
    }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "14654612570-472") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "IS_MANUALLY_PAUSED", type: "boolean", defaultValueBoolean: "false") {
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "14654612570-473") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "SKIPPED_ALERT_GROUP_CODE", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "14632234240-174") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "FUTURE_SCHEDULE_DATE", type: "VARCHAR(1024 )") {
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "234567887654-151") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "AUTO_PAUSED_EMAIL_SENT", type: "boolean") {
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nikhilkhari (generated)", id: "234567887654-152") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "ALERT_DISABLE_REASON", type: "VARCHAR(1024 )") {
                constraints(nullable: "true")
            }
        }
    }
