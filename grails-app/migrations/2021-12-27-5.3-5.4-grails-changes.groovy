    ...
    changeSet(author: "nitesh (generated)", id: "1632254096076-4") {
        ...
        grailsChange {
            change {
                ...
                Map customExpressionMap = ["masterPregnancyFlag":"(SELECT a.state_ynu FROM vw_clp_state_ynu a WHERE a.id=cf.flag_pregnancy AND a.tenant_id=cf.tenant_id AND a.lang_id = '1')",
