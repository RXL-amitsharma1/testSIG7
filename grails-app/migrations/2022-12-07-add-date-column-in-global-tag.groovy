databaseChangeLog = {
    ...
    changeSet(author: "Krishna Joshi (generated)", id: "1670833953002-05") {
        ...
        sql("ALTER TABLE SINGLE_GLOBAL_TAGS ALTER COLUMN CREATION_DATE SET DEFAULT CURRENT_TIMESTAMP;")
    }
    changeSet(author: "Krishna Joshi (generated)", id: "1670833953002-06") {
        ...
        sql("ALTER TABLE AGG_GLOBAL_TAGS ALTER COLUMN  CREATION_DATE SET DEFAULT CURRENT_TIMESTAMP;")
    }
    ...
    changeSet(author: "Krishna Joshi (generated)", id: "1670833953002-07") {
        ...
        sql("ALTER TABLE LITERAURE_GLOBAL_TAGS ALTER COLUMN  CREATION_DATE SET DEFAULT CURRENT_TIMESTAMP;")
    }
}