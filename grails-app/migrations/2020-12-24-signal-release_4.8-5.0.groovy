...
databaseChangeLog = {
    ...
    changeSet(author: "nitesh (generated)", id: "1608824568972-98") {
        ...
        sql("alter table ATTACHMENT ALTER COLUMN INPUT_NAME VARCHAR(4000 );")
    }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-102") {
        ...
        addColumn(tableName: "SIGNAL_RMMS") {
            column(name: "communication_type", type: "VARCHAR(255 )", defaultValue: 'rmmType')
        }
    }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-115") {
        ...
        addColumn(tableName: "VALIDATED_SIGNAL") {
            column(name: "WORKFLOW_STATE", type: "VARCHAR(255 )", defaultValue: "Safety Observation Validation")
        }
    }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-117") {
        ...
        createTable(tableName: "SYSTEM_CONFIG") {
            ...
            column(name: "ENABLE_SIGNAL_WORKFLOW", type: "boolean", defaultValue: "false"){
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nitesh (generated)", id: "1608824568972-121") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "IS_AUTO_ASSIGNED_TO", type: "boolean", defaultValueBoolean: "false")
        }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-129") {
        ...
        addColumn(tableName: "EX_STATUS") {
            column(name: "alert_file_path", type: "VARCHAR(2000 )")
        }
    }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-140") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "is_resume", type: "boolean",defaultValueBoolean: "false") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "anshul (generated)", id: "1608824568972-147") {
        ...
        sql("alter table ARCHIVED_AGG_ALERT ALTER COLUMN FORMAT VARCHAR(8000 );")
    }
    ...
    changeSet(author: "Nikhil (generated)", id: "1608824568972-150") {
        ...
        dropNotNullConstraint(columnDataType: "BOOLEAN", columnName: "listedness", tableName: "EVDAS_ALERT")
    }
    ...
    changeSet(author: "Nikhil (generated)", id: "1608824568972-151") {
        ...
        dropNotNullConstraint(columnDataType: "BOOLEAN", columnName: "listedness", tableName: "ARCHIVED_EVDAS_ALERT")
    }
    ...
    changeSet(author: "ankit (generated)", id: "1608824568972-158") {
        ...
        addColumn(tableName: "EX_RCONFIG") {
            column(name: "new_counts", type: "number(10, 0)", defaultValue: "false") {
                constraints(nullable: "false")
            }
        }
                ...
                try {
                    ...
                    CREATE TABLE PVS_GLOBAL_TAG_TEMP
                        ("ID" NUMBER(19,0),
                         ...
                         "PRIVATE_USER" VARCHAR(255 ), 
                         "SUB_TAG_ID" NUMBER(19,0), 
                         "SUB_TAG_TEXT" VARCHAR(255 ), 
                         "TAG_ID" NUMBER(19,0), 
