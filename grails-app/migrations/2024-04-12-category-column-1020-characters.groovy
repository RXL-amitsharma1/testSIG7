databaseChangeLog = {
    ...
    changeSet(author: "sakshi (generated)", id: "1712927152814-001") {
        ...
        sql("alter table PVS_ALERT_TAG add TAG_TEXT1 VARCHAR(1020 )")
    ...
    changeSet(author: "sakshi (generated)", id: "1712927152814-002") {
        ...
        sql("alter table PVS_ALERT_TAG add SUB_TAG_TEXT1 VARCHAR(1020 )")
    ...
    changeSet(author: "sakshi (generated)", id: "1712927152814-003") {
        ...
        sql("alter table PVS_GLOBAL_TAG add TAG_TEXT1 VARCHAR(1020 )")
    ...
    changeSet(author: "sakshi (generated)", id: "1713156627026-004") {
        ...
        sql("alter table PVS_GLOBAL_TAG add SUB_TAG_TEXT1 VARCHAR(1020 )")
