databaseChangeLog = {
    ...
    changeSet(author: "amrendra (generated)", id: "1573631364906-23") {
        ...
        addColumn(tableName: "SINGLE_CASE_ALERT") {
            column(name: "is_duplicate", type: "boolean", defaultValue :"0") {
                constraints(nullable: "false")
            }
        }
    }
    ...
    changeSet(author: "rishabhgupta (generated)", id: "20190823140830-6") {
        ...
        modifyDataType(columnName: "JUSTIFICATION", newDataType: "VARCHAR(4000 )", tableName: "EVDAS_HISTORY")
    }
    ...
    changeSet(author: "rishabhgupta (generated)", id: "20190823140830-9") {
        ...
        modifyDataType(columnName: "JUSTIFICATION", newDataType: "VARCHAR(4000 )", tableName: "PRODUCT_EVENT_HISTORY")
    }

    changeSet(author: "amrendra (generated)", id: "1573900006619-159") {
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'N', "SELECT  Nullable FROM user_tab_columns " +
                    "WHERE table_name = 'EMAIL_LOG' AND column_name = 'SENT_TO' ;")
        }
        dropNotNullConstraint(columnDataType: "varchar(4000)", columnName: "sent_to", tableName: "EMAIL_LOG")
    }

    changeSet(author: "amrendra (generated)", id: "1573900006619-161") {
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'N', "SELECT  Nullable FROM user_tab_columns " +
                    "WHERE table_name = 'EMAIL_LOG' AND column_name = 'SUBJECT' ;")
        }
        dropNotNullConstraint(columnDataType: "varchar(4000)", columnName: "subject", tableName: "EMAIL_LOG")
    }
}
