databaseChangeLog = {
    ...
    changeSet(author: "amrendra (generated)", id: "1640244010-1") {
        ...
        createTable(tableName: "master_configuration") {
            ...
            column(name: "as_of_version_date", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }

            column(name: "config_template", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
            ...
            column(name: "product_hierarchy", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
            ...
            column(name: "SCHEDULE_DATEJSON", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
    ...
    changeSet(author: "amrendra (generated)", id: "1640244010-4") {
        ...
        addColumn(tableName: "RCONFIG") {
            column(name: "is_latest_master", type: "boolean") {
                constraints(nullable: "true")
            }
        }
    }
    ...
    changeSet(author: "nitesh (generated)", id: "1635495301070-371") {
        ...
        addColumn(tableName: "EX_RCONFIG") {
            column(name: "disabled_dss_nodes", type: "VARCHAR(4000 )") {
                constraints(nullable: "true")
            }
        }
    }
