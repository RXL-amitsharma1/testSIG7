...
databaseChangeLog = {
    ...
    changeSet(author: "rishabhgupta (generated)", id: "1577349618529-1") {
        ...
        modifyDataType(columnName: "EVENT_SELECTION", newDataType: "VARCHAR(8000 )", tableName: "ALERTS")
    }
    ...
    changeSet(author: "rishabhgupta (generated)", id: "1577349618529-2") {
        ...
        modifyDataType(columnName: "CONTENT", newDataType: "VARCHAR(8000 )", tableName: "INBOX_LOG")
    }
    ...
    changeSet(author: "anshul (generated)", id: "1588796599646-1") {
        ...
        modifyDataType(tableName: "ATTACHMENT", columnName: "REFERENCE_LINK", newDataType: "VARCHAR(2000 )")
    }
    ...
    changeSet(author: "ankit (generated)", id: "1580891106735-2") {
        ...
        addColumn(tableName: "REPORT_HISTORY") {
            column(name: "IS_REPORT_GENERATED", type: "boolean",defaultValueBoolean: "false") {
