...
databaseChangeLog = {
    changeSet(author: "bhupender (generated)", id: "202306050-01") {
        ...
        addColumn(tableName: "SYSTEM_CONFIG") {
            column(name: "DATE_CLOSED_DISPOSITION", type: "VARCHAR(8000 )") {
    ...
    changeSet(author: "bhupender (generated)", id: "202306050-04") {
        ...
        addColumn(tableName: "SYSTEM_CONFIG") {
            column(name: "DATE_CLOSED_DISPOSITION_WORKFLOW", type: "VARCHAR(8000 )") {
                constraints(nullable: "true")
            }
        }
    }
    changeSet(author: "bhupender (generated)", id: "202306050-05") {
        ...
        addColumn(tableName: "SYSTEM_CONFIG") {
            column(name: "DATE_CLOSED_WORKFLOW", type: "VARCHAR(8000 )") {
                constraints(nullable: "true")
            }
        }
    }
    changeSet(author: "bhupender (generated)", id: "20230605-06") {
        ...
        addColumn(tableName: "SYSTEM_CONFIG") {
            column(name: "IS_DISPOSITION", type: "boolean", defaultValueBoolean: "true") {
                constraints(nullable: "true")
            }
        }
    }
