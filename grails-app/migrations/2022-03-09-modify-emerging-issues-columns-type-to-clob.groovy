...
databaseChangeLog = {
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-1") {
        ...
        sql("alter table EMERGING_ISSUE add EVENTS1 TEXT")
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-2") {
        ...
        sql("alter table EMERGING_ISSUE add EVENT_SELECTION1 TEXT")
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-3") {
        ...
        sql("alter table EMERGING_ISSUE add PRODUCT_SELECTION1 TEXT")
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-4") {
        ...
        sql("alter table EMERGING_ISSUE add EVENT_GROUP_SELECTION1 TEXT")
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-5") {
        ...
        sql("alter table EMERGING_ISSUE add PRODUCTS1 TEXT")
    ...
    changeSet(author: "krishan (generated)", id: "1646896501-6") {
        ...
        sql("alter table EMERGING_ISSUE add PRODUCT_GROUP_SELECTION1 TEXT")
    ...
    changeSet(author: "rahul (generated)", id: "37283791301-8") {
        ...
        modifyDataType(columnName: "JUSTIFICATION", newDataType: "VARCHAR(8000 )", tableName: "JUSTIFICATION")
    }
    ...
    changeSet(author: "Rahul (generated)", id: "37283791301-22") {
            ...
            addColumn(tableName: "EX_RCONFIG") {
                column(name: "STRATIFICATION_COLUMNS",  type: "VARCHAR(8000 )"){
                    constraints(nullable: "true")
                }
            }
    }
    ...
    changeSet(author: "Rahul (generated)", id: "37283791301-23") {
            ...
            addColumn(tableName: "EX_RCONFIG") {
                column(name: "STRAT_COL_DATA_MINING",  type: "VARCHAR(8000 )"){
                    constraints(nullable: "true")
                }
            }
    }
