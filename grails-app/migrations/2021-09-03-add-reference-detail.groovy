...
databaseChangeLog = {
    ...
    changeSet(author: "suraj (generated)", id: "1630847171273-13") {
        ...
        createTable(tableName: "ATTACHMENT_REFERENCE") {
            ...
            column(name: "input_name", type: "VARCHAR(4000 )") {
                constraints(nullable: "false")
            }
            column(name: "attachment_type", type: "VARCHAR(4000 )") {
                constraints(nullable: "false")
            }
...
/*   changeSet(author: "suraj (generated)", id: "1632334132323-150") {
        ...
        sql("alter table REFERENCE_DETAILS ALTER COLUMN description VARCHAR(4000 );")
    }*/

    changeSet(author: "rahul (generated)", id: "1630661135578-14") {
        preConditions(onFail: 'MARK_RAN') {
            columnExists(tableName: 'REFERENCE_DETAILS', columnName: 'description')
            not {
                sqlCheck(expectedResult: '8000', "SELECT character_maximum_length FROM information_schema.columns WHERE table_name = 'reference_details' AND column_name = 'description';")
            }
        }
        sql("ALTER TABLE REFERENCE_DETAILS ALTER COLUMN description TYPE VARCHAR(8000);")
    }
    ...
    changeSet(author: "mohit (generated)", id: "1631688158043-153") {
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'NO', "SELECT is_nullable FROM information_schema.columns WHERE table_name = 'action_types' AND column_name = 'description';")
        }
        sql("ALTER TABLE action_types ALTER COLUMN description TYPE VARCHAR(255);")
        sql("ALTER TABLE action_types ALTER COLUMN description DROP NOT NULL;")
    }
    ...
    changeSet(author: "shivam (generated)", id: "20220106131958-3") {
        ...
        addColumn(tableName: "REFERENCE_DETAILS") {
            column(name: "fav_icon_url", type: "VARCHAR(255 )") {
                constraints(nullable: "true")
            }
        }
    }
