databaseChangeLog = {
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-58") {
        createTable(tableName: "ARCHIVED_SINGLE_CASE_ALERT") {
            ...
            column(name: "combo_flag", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
            ...
            column(name: "malfunction", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-111") {
        createTable(tableName: "EX_EVDAS_CONFIG") {
            ...
            column(name: "disp_counts", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-119") {
        createTable(tableName: "EX_RCONFIG") {
            ...
            column(name: "is_auto_assigned_to", type: "boolean") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-122") {
        createTable(tableName: "EX_STATUS") {
            ...
            column(name: "alert_file_path", type: "VARCHAR(255 )")
            ...
            column(name: "spotfire_execution_status", type: "VARCHAR(255 )")

            column(name: "spotfire_file_name", type: "VARCHAR(2000 )")

            column(name: "STACK_TRACE", type: "CLOB")

            column(name: "START_TIME", type: "NUMBER(19, 0)")

            column(name: "time_stampjson", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-152") {
        createTable(tableName: "PRODUCT_ASSIGNMENT_LOG") {
            ...
            column(name: "imported_file_name", type: "VARCHAR(255 )") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-157") {
        createTable(tableName: "PVUSER") {
            ...
            column(name: "COL_ORDER", type: "VARCHAR(2000 )")

            column(name: "COL_USER_ORDER", type: "VARCHAR(2000 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-198") {
        createTable(tableName: "SIGNAL_STATUS_HISTORY") {
            ...
            column(name: "from_signal_status", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-202") {
        createTable(tableName: "SIGNAL_WORKFLOW_STATE") {
            ...
            column(name: "default_display", type: "boolean") {
                constraints(nullable: "false")
            }
            ...
            column(name: "due_in_display", type: "boolean") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-225") {
        createTable(tableName: "SYSTEM_CONFIG") {
            ...
            column(name: "ENABLE_SIGNAL_WORKFLOW", type: "boolean")
        }
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-252") {
        createTable(tableName: "VALIDATED_SIGNAL") {
            ...
            column(name: "workflow_state", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-297") {
        createTable(tableName: "signal_email_log") {
            ...
            column(name: "body", type: "VARCHAR(8000 )") {
                constraints(nullable: "false")
            }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-301") {
        createTable(tableName: "spotfire_notification_query") {
            ...
            column(name: "signal_parameters", type: "VARCHAR(4000 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-308") {
        createTable(tableName: "user_dashboard_counts") {
            ...
            column(name: "group_disp_case_counts", type: "VARCHAR(4000 )")

            column(name: "group_disppecounts", type: "VARCHAR(4000 )")

            column(name: "group_due_date_case_counts", type: "VARCHAR(8000 )")

            column(name: "group_due_datepecounts", type: "VARCHAR(8000 )")

            column(name: "user_disp_case_counts", type: "VARCHAR(4000 )")

            column(name: "user_disppecounts", type: "VARCHAR(4000 )")

            column(name: "user_due_date_case_counts", type: "VARCHAR(8000 )")

            column(name: "user_due_datepecounts", type: "VARCHAR(8000 )")
        }
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-315") {
        createTable(tableName: "view_instance") {
            ...
            column(name: "icon_seq", type: "VARCHAR(255 )")
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-342") {
        ...
        addPrimaryKey(columnNames: "EX_EVDAS_CONFIG_ID, ACTIVITY_ID", constraintName: "EX_EVDAS_CONFIG_ACTIVITIESPK", tableName: "EX_EVDAS_CONFIG_ACTIVITIES")
    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-368") {
        ...
        addPrimaryKey(columnNames: "user_id", constraintName: "user_dashboard_countsPK", tableName: "user_dashboard_counts")
    }
...
//    }
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-8661") {
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-8671") {
        preConditions(onFail: 'MARK_RAN') {
    ...
    changeSet(author: "chetansharma (generated)", id: "1608626578687-8681") {
        preConditions(onFail: 'MARK_RAN') {
    ...
    changeSet(author: "anshul (generated)", id: "1608626578687-886") {
        ...
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'character varying', "SELECT data_type FROM information_schema.columns WHERE table_name = 'single_case_alert' AND column_name = 'master_pref_term_all';")
        }
    ...
    changeSet(author: "anshul (generated)", id: "1608626578687-887") {
        ...
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'character varying', "SELECT data_type FROM information_schema.columns WHERE table_name = 'archived_single_case_alert' AND column_name = 'master_pref_term_all';")
        }
    ...
    changeSet(author: "anshul (generated)", id: "1608626578687-888") {
        ...
        preConditions(onFail: 'MARK_RAN') {
            sqlCheck(expectedResult: 'character varying', "SELECT data_type FROM information_schema.columns WHERE table_name = 'single_on_demand_alert' AND column_name = 'master_pref_term_all';")
        }
    ...
    changeSet(author: "nitesh (generated)", id: "1608626578687-893") {
        ...
        sql("alter table ATTACHMENT ALTER COLUMN INPUT_NAME TYPE VARCHAR(4000 );")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-1") {
        ...
        sql("alter table AUDIT_LOG  add TRANSACTION_ID VARCHAR(255);")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-2") {
        ...
        sql("ALTER TABLE audit_log ADD COLUMN is_first_entry_in_transaction BOOLEAN;")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-3") {
        ...
        sql("alter table AUDIT_LOG  add MODULE_NAME VARCHAR(255);")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-4") {
        ...
        sql("alter table AUDIT_LOG  add DEVICE VARCHAR(255);")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831814030211-5") {
        ...
        sql("alter table AUDIT_LOG  add BROWSER VARCHAR(255);")
    }
    ...
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-6") {
        ...
        sql("alter table AUDIT_LOG  add TIME_ZONE VARCHAR(255);")
    }
    changeSet(author: "Uddesh Teke (generated)", id: "16831841030211-7") {
        ...
        sql("alter table AUDIT_LOG  add DESCRIPTION VARCHAR(255);")
    }
