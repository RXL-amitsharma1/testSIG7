databaseChangeLog = {
    ...
    changeSet( author: "Krishna Joshi (generated)", id: "1692250766534-0030" ) {
        ...
        sql( "alter table LITERATURE_ACTIVITY add PRODUCT_NAME1 TEXT;" )
    ...
    changeSet( author: "Krishna Joshi (generated)", id: "1692250766534-0040" ) {
        ...
        sql( "alter table LITERATURE_ACTIVITY add EVENT_NAME1 TEXT;" )
    ...
    changeSet(author: "Krishna Joshi (generated)", id: "1704360006983-0042") {
        ...
        sql("alter table SIGNAL_REPORT ALTER COLUMN REPORT_NAME TYPE VARCHAR(1500 );")
    ...
    changeSet(author: "Krishna Joshi (generated)", id: "1704360006983-0043") {
        ...
        sql("alter table INBOX_LOG ALTER COLUMN MESSAGE TYPE VARCHAR(1500 );")
    ...
    changeSet(author: "Krishna Joshi (generated)", id: "1704360006983-0044") {
        ...
        sql("alter table INBOX_LOG ALTER COLUMN MESSAGE_ARGS TYPE VARCHAR(1500 );")
