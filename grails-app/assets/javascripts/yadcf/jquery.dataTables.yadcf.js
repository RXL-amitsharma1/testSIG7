...
(function ($, window, document, undefined) {
    var yadcf = (function () {
        ...
        function getSettingsObjFromTable(dt) {
            ...
            } else if (dt.settings) { // 1.9 compatibility
                // DataTables object, convert to the settings object
                oDTSettings = dt.settings();
        ...
        function yadcfVersionCheck(version) {
            var aThis = $.fn.DataTable.version.split('.'),
                aThat = version.split('.'),
                iThis,
                iThat,
                i,
        ...
        function replaceAll(string, find, replace) {
            return string.toString().replace(new RegExp(escapeRegExp(find), 'g'), replace);
        }
        ...
        function yadcfMatchFilterString(table_arg, column_number, selected_value, filter_match_mode, multiple, exclude) {
            ...
            table_arg.settings().aoPreSearchCols[column_number].bSmart = false;
            table_arg.settings().aoPreSearchCols[column_number].bRegex = true;
            table_arg.settings().aoPreSearchCols[column_number].bCaseInsensitive = case_insensitive;

            if (multiple === undefined || multiple === false) {
                if (exclude !== true) {
                    if (filter_match_mode === "contains") {
                        table_arg.settings().aoPreSearchCols[column_number].bSmart = true;
                        table_arg.settings().aoPreSearchCols[column_number].bRegex = false;
        ...
        function doFilterCustomDateFunc(arg, table_selector_jq_friendly, column_number) {
            ...
            if (!oTable.settings().oLoadedState) {
                oTable.settings().oLoadedState = {};
                oTable.settings().oApi._fnSaveState(oTable.settings());
            }
            if (oTable.settings().oFeatures.bStateSave === true) {
                if (oTable.settings().oLoadedState.yadcfState !== undefined && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly] !== undefined) {
                    oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number] =
                        {
                            from: arg.value
                        };
                } else {
                    ...
                    oTable.settings().oLoadedState.yadcfState = yadcfState;
                }
                oTable.settings().oApi._fnSaveState(oTable.settings());
            }
        ...
        function addRangeNumberFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, ignore_char) {
            ...
            if (oTable.settings().oFeatures.bStateSave === true && oTable.settings().oLoadedState) {
                if (oTable.settings().oLoadedState.yadcfState && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly] && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number]) {
                    $('#' + fromId).val(oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].from);
                    if (oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].from !== "") {
                        $('#' + fromId).addClass("inuse");
                    }
                    $('#' + toId).val(oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].to);
                    if (oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].to !== "") {
                        $('#' + toId).addClass("inuse");
                    }
                }
            }
            ...
            if (oTable.settings().oFeatures.bServerSide !== true) {
        ...
        function addDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
            ...
            if (oTable.settings().aoPreSearchCols[column_number].sSearch !== '') {
                $('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number).val(oTable.settings().aoPreSearchCols[column_number].sSearch).addClass("inuse");
            }
            ...
            if (columnObj.filter_type === 'date_custom_func') {
                ...
                if (oTable.settings().oFeatures.bStateSave === true && oTable.settings().oLoadedState) {
                    if (oTable.settings().oLoadedState.yadcfState && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly] && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number]) {
                        $('#' + dateId).val(oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].from);
                        if (oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number].from !== "") {
        ...
        function appendFilters(oTable, args, table_selector, pSettings) {
            ...
            for (columnObjKey in args) {
                if (args.hasOwnProperty(columnObjKey)) {
                    ...
                    if(typeof selectedFilter !=="undefined" && selectedFilter==true){
                        $('.yadcf-filter-wrapper').hide(); // Added for PVS-63986
                    }
                    ...
                    if (filter_container_id === undefined && columnObj.filter_container_selector === undefined) {
                        ...
                        if (filters_position !== 'thead') {
                            ...
                            const column_position_condition = unique_th ? unique_th[column_position] : 1;
                            if (columnObj.filters_tr_index === undefined) {
                                filter_selector_string = table_selector + ' ' + filters_position + ' tr:eq(' + $(column_position_condition).parent().index() + ') th:eq(' + $(column_position_condition).index() + ')';
                            } else {
                    ...
                    if ($filter_selector.length === 1) {
                        ...
                        if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
                            ...
                            if (columnObj.filter_type === "select") {
                                ...
                                if (columnObj.externally_triggered === true || columnObj.fixed_column == true) {
                                    filterActionStr = '';
                                }
                                $(filter_selector_string).append("<select id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"custom-select-product yadcf-filter " + columnObj.style_class + "\" " +
                            ...
                            //add a wrapper to hold both filter and reset button
                            var centerClass = columnObj.style_class === "countFilter" ? " filter-center" : "";
                            $(filter_selector_string).append("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper" + centerClass + "\"></div>");
                            filter_selector_string += " div.yadcf-filter-wrapper";

                            if(!columnObj.fixed_column) {
                            ...
                            if (settingsDt.aoPreSearchCols[column_position].sSearch !== '') {
                                ...
                                const options = getOptions(oTable.selector) ? getOptions(oTable.selector)[column_number].filter_match_mode : '';
                                tmpStr = yadcfParseMatchFilter(tmpStr, options);
                                $('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number).val(tmpStr).addClass("inuse");
                            }
	...
	*/
        ...
        function scrollXYHandler(oTable, table_selector) {
            ...
            if (oTable.settings().oScroll?.sX !== '' || oTable.settings().oScroll?.sY !== '') {
        ...
        function initAndBindTable(oTable, table_selector, index, pTableDT) {
            ...
            if (oTable.settings().bStateSave === true) {
                if (yadcfVersionCheck('1.10')) {
        ...
        function init(oTable, options_arg, params) {
            ...
            if ($(instance.selector).length === 1) {
                ...
                initAndBindTable(oTable, instance.selector, 0, oTable);
            } else {
                ...
                for (j = 0; j < col_filter_arr.length; j++) {
                    ...
                    switch (optionsObj.filter_type) {
                        ...
                        case 'date':
                            ...
                            table_arg.settings().aoPreSearchCols[column_position].sSearch = tmpStr;
                            break;
                        case 'select':
                            $('#yadcf-filter-' + table_selector_jq_friendly + '-' + column_number).val(filter_value);
                            if (filter_value !== '') {
                        ...
                        case 'range_date':
                            ...
                            if (table_arg.settings().oFeatures.bServerSide === true) {
                                min = filter_value.from;
                                max = filter_value.to;
                                table_arg.settings().aoPreSearchCols[column_position].sSearch = min + '-yadcf_delim-' + max;
                            }
                        ...
                        case 'range_number':
                            ...
                            if (table_arg.settings().oFeatures.bServerSide === true) {
                                table_arg.settings().aoPreSearchCols[column_position].sSearch = filter_value.from + '-yadcf_delim-' + filter_value.to;
                            }
                            saveStateSave(table_arg, column_number, table_selector_jq_friendly, filter_value.from, filter_value.to);
                            break;
                        case 'range_number_slider':
                        ...
                        case 'multi_select_custom_func':
                            ...
                            if (table_arg.settings().oFeatures.bServerSide === true) {
                                table_arg.settings().aoPreSearchCols[column_position].sSearch = filter_value;
                            }
                            if (optionsObj.select_type !== undefined) {
        ...
        function exGetColumnFilterVal(table_arg, column_number) {
            ...
            var textType
            if(optionsObj.filter_type !== undefined){
                textType = optionsObj.filter_type
            } else{
                textType = optionsObj.column_data_type
            }
            switch (textType) {
                case 'select':
                case 'custom_func':
        ...
        function clearStateSave(oTable, column_number, table_selector_jq_friendly) {
            ...
            if (oTable.settings().oFeatures.bStateSave === true) {
                ...
                if (oTable.settings().oLoadedState.yadcfState !== undefined && oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly] !== undefined) {
                    oTable.settings().oLoadedState.yadcfState[table_selector_jq_friendly][column_number] = undefined;
                } else {
                    yadcfState = {};
                    yadcfState[table_selector_jq_friendly] = [];
                ...
                if (tableOptions.hasOwnProperty(columnObjKey)) {
                    ...
                    switch (optionsObj.filter_type) {
                        ...
                        case 'custom_func':
                            ...
                            table_arg.settings().aoPreSearchCols[column_number].sSearch = '';
                            if (optionsObj.select_type !== undefined) {
