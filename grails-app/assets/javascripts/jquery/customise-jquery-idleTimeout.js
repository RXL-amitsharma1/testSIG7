...
/* Modified this file. Added line:236 to avoid NaN issue */
(function ($) {
    ...
    $.fn.idleTimeout = function (userRuntimeConfig) {
        ...
        countdownDisplay = function () {
            ...
            remainingTimer = setInterval(function () {
                ...
                if (dialogDisplaySeconds <= 0) dialogDisplaySeconds = 0;  //Added this condition to avoid NaN issue coming on popup
            }, 1000);
        };
        ...
        logoutUser = function () {
            ...
            //TODO need to find reason Dirty hack to eliminate multiple logout event call.
            logoutCallTimes++;
            if (logoutCallTimes > 1) {
                console.log("Logout got called more than 1 time : " + (logoutCallTimes));
                return;
            }
