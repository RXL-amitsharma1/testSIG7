...
class EvdasAlert extends BaseEvdasAlert {
    ...
    static hasMany = [actions         : Action,
                      signalConcepts  : MedicalConcepts,
                      topicConcepts   : MedicalConcepts,
                      validatedSignals: ValidatedSignal]

    static mapping = {
        table("EVDAS_ALERT")
        id generator:'sequence', params:[sequence:'evdas_sequence']
        ...
        signalConcepts joinTable: [name: "EVDAS_SIGNAL_CONCEPTS", column: "MEDICAL_CONCEPTS_ID", key: "EVDAS_ALERT_ID"]
        topicConcepts joinTable: [name: "EVDAS_TOPIC_CONCEPTS", column: "MEDICAL_CONCEPTS_ID", key: "EVDAS_ALERT_ID"]
        validatedSignals joinTable: [name: "VALIDATED_EVDAS_ALERTS", column: "VALIDATED_SIGNAL_ID", key: "EVDAS_ALERT_ID"]
        actions joinTable: [name: "EVDAS_ALERT_ACTIONS", column: "ACTION_ID", key: "EVDAS_ALERT_ID"]
        evImpEventList joinTable: [name: "EVDAS_ALERT_IMP_EVENT_LIST", key: "EVDAS_ALERT_ID", column: "EVDAS_IMP_EVENTS"]
    ...
    Boolean canAddToTopic(PVSState validationPVSState) {
        false
    }
