...
<div class="panel panel-default rxmain-container rxmain-container-top m-b-0">
            ...
            <div class="col-md-5 ico-menu">
                ...
                <div class="pull-right dropdown-menu" aria-labelledby="dropdownMenu2">
                    <div class="rxmain-container-dropdown">
                        <div>
                            <table id="tableColumns2" class="table table-striped pv-list-table dataTable no-footer rxmain-dropdown-settings-table">
    ...
    <div class="rxmain-container-content">
        <table id="alertTagsList" class="table table-striped pv-list-table dataTable no-footer" width="100%">
                <thead>
                <tr>
                    <th class="nameColumn">
