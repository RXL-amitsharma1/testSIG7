<%@ page import="com.rxlogix.util.ViewHelper; com.rxlogix.util.DateUtil;com.rxlogix.util.AuditLogConfigUtil; com.rxlogix.config.Tag; com.rxlogix.pvdictionary.config.PVDictionaryConfig" %>
<g:set var="reportService" bean="reportService"/>
<head>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Product/Product Group(s):</label> ${reportHistory?.productGroup ? AuditLogConfigUtil.getGroupNameFieldFromJsonForAudit(reportHistory?.productGroup) : reportService.isValidJson(reportHistory?.productName) ? AuditLogConfigUtil.getProductSelectionValuesForAudit(reportHistory?.productName) : reportHistory?.productName}
                                </div>
                            </div>
                        </div>
                    </div>
