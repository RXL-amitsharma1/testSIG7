...
<script>
    $(function () {
        $("#statistical-comparison, #ic-statistical-comparison").on('click', function () {
...
<script>
    $('.bookmarks-list-opener').on('hover', function () {
                    ...
                    <g:if test="${callingScreen == Constants.Commons.REVIEW || callingScreen == Constants.Commons.DASHBOARD}">
                        <li class="li-pin-width dropdown-submenu">
                            <a class="test text-left-prop"  href="#">
                                ...
                                <span class="dropdown-toggle grid-menu-tooltip" data-toggle="dropdown" tabindex="0" role="button"
                                      accesskey="x" aria-expanded="true">
...
%{--                    PVS-55163 This code ensure Column level filtering available for both latest and archived alert of evdas alert.--}%
                        <li class="li-pin-width">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <table id="alertsDetailsTable" class="auto-scale table-striped pv-list-table hover" width="100%">
                <thead>
                <tr id="alertsDetailsTableRow" class="evdas-header-row">
                    ...
                    <g:if test="${isPriorityEnabled}">
                        <th data-idx="4" data-field="priority"><div class="th-label" data-field="priority"><g:message code="app.label.evdas.details.column.priority"/></div></th>
                    </g:if>
                    <th data-idx="5" data-field="actions"><div class="th-label" data-field="actions"><g:message code="app.label.evdas.details.column.actions"/></div></th>
                    ...
                    <th data-idx="56" style="min-width: 150px !important;" data-field="dispLastChange">
