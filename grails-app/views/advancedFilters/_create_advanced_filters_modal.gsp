    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <g:render template="/advancedFilters/includes/form"
                          model="[isShareFilterViewAllowed: isShareFilterViewAllowed, isDataMiningScreen: isDataMiningScreen ? isDataMiningScreen : false]"/>
