<head>
    ...
    <style>
    .pvs-validate-tabpan .dt-search { display: block; }
    </style>
</head>
...
<div class="pvs-validate-tabpan">
    ...
    <rx:container title="Generated Reports">
        ...
        <table id="signalReportTable" class="table table-striped pv-list-table hover" width="100%">
            <thead>
            <tr>
                <th>Report Name</th>
                <th>Product</th>
    ...
    <rx:container title="Template Library">
        <div>
            <table id="rxTableTemplates" class="table table-striped pv-list-table hover" width="100%">
                <thead>
                <tr>
