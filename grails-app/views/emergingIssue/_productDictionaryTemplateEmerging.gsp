                    ...
                    <g:if test="${filter.type == 'SELECTBOX'}">
                        <g:if test="${PVDictionaryConfig.select2v4}">
                            <select level="${i + 1 + views.size()}" name="${filter.name}"
                                    data-placeholder="${message(code: 'select.one')}"
...
<div class="row" style="padding-top: 1%">
    ...
    <div class="col-xs-4">
        <g:select id="dataSourcesProductDict"
...
<div class="row" style="margin-top: 1%">
    <div class="col-xs-5 padding-md-bottom" style="width: 140px;">
        <div class="checkbox checkbox-primary">
            <g:checkBox id="product_exactSearchAssessment" name="product_exactSearchAssessment"/>
    ...
    <div class="col-xs-5 padding-md-bottom" id="who_dr_checkbox_div_assessment" style="width: 180px;">
        <div class="checkbox checkbox-primary">
            <input type="checkbox" name="who_dr_checkbox_assessment" id="who_dr_checkbox_assessment">
            <label for="who_dr_checkbox_assessment">
                <g:message code="app.label.productDictionary.who.drug" default="Include WHO Drugs"/>
            </label>
        </div>
    </div>
...
<div class="${column_names.size() <=6 ? "m-b-15 scroll-hidden" : "m-b-15 scroll-hidden scrollableView1"}">
    ...
    <g:each var="viewEntry" in="${views}" status="i">
        ...
        <div class="${column_names.size() <=6 ? "prodDictFilterColCalc padding-md-bottom" : "prodDictFilterCol"}">
            ...
            <input level="${i + 1}"
                   class="searchProducts form-control ${viewEntry.code == productColumnCode ? 'productColumn' : ''}" id="${i + "_prod"}"
                   type="text" name="${viewEntry.fieldName}">
        </div>
    </g:each>
</div>
...
<div class="row selectedProductDictionaryValueAssessment">
    ...
    <div class="col-xs-10">
        ...
        <div id="drugRecordSelectionAssessment" class="row" style="display: none">
            <div class="col-xs-3">
                <label><g:message code="app.label.productDictionary.drug.record.number" default="Drug Record Number"/></label>
            </div>

            <div class="col-xs-9 productDictionaryValueAssessment level100"></div>
        </div>
    </div>
</div>
<div class="row">
