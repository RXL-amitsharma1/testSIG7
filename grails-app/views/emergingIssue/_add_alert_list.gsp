                ...
                <div class="row">
                    ...
                    <div class="col-md-6 row display-flex">
                        <div class="col-md-2 col-md-offset-1 text-right-prop">
                            ...
                            <label class="pv-switch">
                                <input id="ime"
                                       ...
                                       type="checkbox"
                                       class="form-element"
                                       data-value="${emergingIusseList?.ime}"
                                />
                        ...
                        <div class="col-md-2 text-right-prop">
                            ...
                            <label class="pv-switch">
                                <input id="dme"
                                       ...
                                       type="checkbox"
                                       class="form-element"
                                       data-value="${emergingIusseList?.dme}"
                                />
                                <span class="switch-slider"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-md-2 text-right-prop">
                            ...
                            <label class="pv-switch">
                                <input id="emergingIssue"
                                       name="emergingIssue"
                                       type="checkbox"
                                       class="form-element"
                                       data-value="${emergingIusseList?.emergingIssue}"
                                />
                                <span class="switch-slider"></span>
                            </label>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <label class="pv-switch">
                                <input id="specialMonitoring"
                                       name="specialMonitoring"
                                       type="checkbox"
                                       class="form-element"
                                       data-value="${emergingIusseList?.specialMonitoring}"
                                />
                                <span class="switch-slider"></span>
                            </label>
                        </div>
