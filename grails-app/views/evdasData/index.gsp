    ...
    <div class="rxmain-container rxmain-container-top">
        <div class="rxmain-container-inner">
            ...
            <div class="rxmain-container-content">
                <g:form action="upload" enctype="multipart/form-data" name="formEvdasDataUpload" method="post">
                    <div class="row">
                        <div class="col-md-3">
...
<div class="rxmain-container rxmain-container-top">
    <div class="rxmain-container-inner">
        ...
        <div class="rxmain-container-content">
            ...
            <div>
                <table id="eudraDataTable" class="table table-striped pv-list-table hover" width="100%">
                    <thead>
                    <tr>
