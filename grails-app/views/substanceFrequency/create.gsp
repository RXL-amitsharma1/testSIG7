...
<rx:container title="${message(code: "app.label.substance.frequency")}">
    <g:form method='post' url="[controller:'SubstanceFrequency',action:'save']" name="substanceFrequencyForm">
        ...
        <div class="buttons ">
        <g:submitButton name="submitForm" value="Save" class="btn btn-primary"></g:submitButton>
        </div>
        </div>
    </g:form>
</rx:container>
