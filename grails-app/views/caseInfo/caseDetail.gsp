...
<head>
    ...
    <g:javascript>
        ...
        var isCommentsEditEnable = "${isCommentsEditEnable}";
    ...
    <div class="row">
        <div id="detail-tabs" class="col-md-12 panel m-b-0">
            <div role="presentation" class="${(!isFaers && !isVaers && !isVigibase && !isJader)?"col-sm-5":"col-sm-12"}">
                <h4 aria-controls="details" style="float: left; margin-right: 20px;" role="tab">${isFaers ? "FAERS" : isVigibase ? "VigiBase" : isVaers ? "VAERS" : isJader ? "JADER" : "Safety DB"} - Case Number: ${caseVisibility ?: caseNumber}
                            ...
                            <ul class="dropdown-menu export-type-list" id="exportTypesTopic">
                                ...
                                <li><g:link controller="caseInfo" action="exportCaseInfo" class="m-r-30"
                                            params="${[outputFormat: com.rxlogix.enums.ReportFormat.DOCX, isVersion:isVersion,
                                                       ...
                                                       exeConfigId: "${caseDetail?.execConfigId}", isVersion: isVersion, isChildCase: isChildCase, isStandalone: isStandalone, caseVisibility: caseVisibility]}">
...
<div class="info-widget">
    ...
    <div class="treeview-content">
        <g:if test="${caseDetail && !isFaers && !isVaers && !isVigibase && !isJader && !isChildCase && !isSpotfire}">
                            ...
                            <rx:containerCollapsible title="${k}">
                                <div class="scroll-body">
                                    <g:if test="${!isVaers && !isVigibase && sectionRelatedInfo?."${k}".sectionKey == Constants.CaseDetailUniqueName.DEVICE_INFORMATION}">
                                        <table class="table table-striped pv-list-table dataTable no-footer m-t-0 m-b-0 text-left">
                                            <thead>
                                            <tr>
                                ...
                                <g:else>
                                <table class="table table-striped pv-list-table dataTable no-footer m-t-0 m-b-0">
                                    <thead>
        ...
        <g:if test="${!isChildCase && caseDetail && !isFaers && !isVaers && !isVigibase && !isJader}">
            ...
            <g:if test = "${isCommentsEditEnable}">
            ...
            <rx:containerCollapsible class="section m-b-10" title="Actions">
                ...
                <div id="action-list-conainter" class="list">
                    <table id="action-table" class="table table-striped pv-list-table dataTable no-footer" style="width: 100%">
                        <thead>
                        <tr>
            ...
            <rx:containerCollapsible class="section m-b-10" title="History">
                <div id="caseHistoryModal">
                    ...
                    <div id="case-history-container" class="list m-b-10">
                        ...
                        <br/>
                        <table class="table table-striped pv-list-table dataTable no-footer caseHistoryModalTable" id="caseHistoryModalTable" style="width: 100%">
                            <thead>
                            <tr>
                    ...
                    <div id="case-history-container_suspect" class="list m-b-10">
                        ...
                        <br/>
                        <table class="table table-striped pv-list-table dataTable no-footer" id="caseHistoryModalTableSuspect" style="width: 100%">
                            <thead>
                            <tr>
                                <th><g:message code="app.label.alert.name"/></th>
