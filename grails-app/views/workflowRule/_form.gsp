...
<sec:ifAnyGranted roles="ROLE_CONFIGURATION_CRUD">
    <div class="row form-group">
        <div class="col-lg-5">
            <g:if test="${edit}">
                <span class="button disable-check" data-action="update"><g:actionSubmit class="save btn btn-primary" action="update" id="updateRule"
                                                     value="${message(code: 'default.button.update.label', 'default': 'Update')}"/></span>
                <span class="button disable-check" data-action="delete"><g:actionSubmit class="delete btn pv-btn-grey" action="delete" id="deleteRule"
                                                     value="${message(code: 'default.button.delete.label', 'default': 'Delete')}"/></span>
            </g:if>
            <g:else>
                <span class="button"><g:submitButton name="create" class="save btn btn-primary" id="createRule"
