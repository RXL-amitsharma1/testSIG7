    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="details">
            <g:render template="includes/details_tab"
                      model="[id: executedConfigId, name: name, alertDispositionList: alertDispositionList, reportUrl: reportUrl, reportName: reportName, analysisFileUrl: analysisFileUrl, callingScreen: callingScreen, isVaers: isVaers, isVigibase: isVigibase, isJader: isJader, aggExecutionId: aggExecutionId, isCommentsEditEnable: isCommentsEditEnable,
