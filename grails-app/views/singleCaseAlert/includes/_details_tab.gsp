...
%{--                    PVS-55163 This code ensure Column level filtering available for both latest and archived alert of single case alert..--}%
                           <li class="li-pin-width">
...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table id="alertsDetailsTable" class="auto-scale table table-striped pv-list-table dataTable no-footer">
                <thead>
                <tr id="alertsDetailsTableRow" class="single-header-row">
                    <th data-idx="0" data-field="checkbox" data-dt-order="disable">
                    ...
                    <g:if test="${!isAdhocCaseSeries && !isFaers}">
                        ...
                        <g:if test="${!isFaers}">
                            ...
                            <th data-idx="70" data-field="coPackagedProduct">
                                <div class="th-label" data-field="coPackagedProduct">
                                    <g:if test="${columnLabelMap.containsKey('coPackagedProduct')}">
                                        ${columnLabelMap.get('coPackagedProduct')}
                                    </g:if>
                                    <g:else>
                                        <g:message code="app.label.qualitative.details.column.coPackagedProduct"/>
                                    </g:else>
                                </div>
                            </th>
                            <g:if test="${customFieldsEnabled}">
