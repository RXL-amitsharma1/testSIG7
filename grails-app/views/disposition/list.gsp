    ...
    <div class="body">
        <div class="list">
            <table class="dataTable notused">
                <thead>
                <tr>
                    <g:sortableColumn property="displayName" title="Display Name" titleKey="disposition.id"/>
                    <g:sortableColumn property="description" title="Description" titleKey="disposition.description"/>
                    <g:sortableColumn property="value" title="Value" titleKey="disposition.value"/>
