...
<sec:ifAnyGranted roles="ROLE_CONFIGURATION_CRUD">
    <div class="row form-group">
        <div class="col-lg-5">
            <g:if test="${edit}">
                <span class="button"><g:actionSubmit class="save btn btn-primary" action="update" id="updateButton"
                                                     value="${message(code: 'default.button.update.label', 'default': 'Update')}"/></span>
                <span class="button"><g:actionSubmit class="save btn pv-btn-grey hide" action="delete" id="deleteButton"
                                                     value="${message(code: 'default.button.delete.label', 'default': 'Delete')}"/></span>
            </g:if>
            <g:else>
                <span class="button"><g:submitButton name="create" class="save btn btn-primary" id="submitButton"
