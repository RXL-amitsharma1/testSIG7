...
<g:render template="/includes/layout/flashErrorsDivs" bean="${configurationInstance}" var="theInstance"/>
    ...
    <div class="row">
        ...
        <hr style="margin: 10px 20px 2px 0px;"/>
    %{--  added check as part of PVS-61111  --}%
        <g:if test="${Holders.config.product.group.update.precheck.enabled == true}">
            <div class="row">
    ...
    <div class="row">
        <h3>Product View Assignment Migration</h3>
        <div>
            <g:if test="${Holders.config.product.view.assignment.migration.required}">
                <span class="required-indicator">*</span><span>Alert Group</span>
                <g:textField name="alertGroup" id = "alertGroupMigration" class="form-control" placeholder = "Enter Default Alert Group Name"  style="width: 300px;"/><br>
                <button id="run-pva-migrations" href="#" class="btn btn-primary "><g:message code="app.controlpanel.runMigrations"/></button>
            </g:if>
            <g:else>
                <button id="run-pva-migrations" href="#" class="btn btn-primary disabled"><g:message code="app.controlpanel.runMigrations"/></button>
            </g:else>
        </div>
    </div>
    <hr style="margin: 10px 20px 2px 0px;"/>
