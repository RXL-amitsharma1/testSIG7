    ...
    <div class="rxmain-container-inner">
        ...
        <div class="collapse in" id="productManagementContainer">
            <div class="rxmain-container-content ">
                    <table id="productAssignmentTable" class="table table-striped pv-list-table dataTable no-footer row-border hover simple-alert-table" width="100%">
                        <thead>
                        <tr>
                            <th data-idx="0" class="col-md-half sorting_disabled" data-field=""></th>
                            <g:if test="${isProductView}">
                                <th data-idx="1" class="col-md-1" data-field="alertGroup">
                                    Alert Group
                                </th>
                                <th data-idx="2" class="col-md-3-half" data-field="product"><g:message
                                        code="product.assignment.label.product"
                                        default="Product"/>
                                    <span class="required-indicator">*</span>
                                </th>
                                <th data-idx="3" class="col-md-2" data-field="hierarchy"><g:message
                                        code="product.assignment.label.product.hierarchy"
                                        default="Product Hierarchy"/>
                                </th>
                                <th data-idx="4" class="col-md-2" data-field="assignedUserOrGroup"><g:message
                                        code="product.assignment.label.assignment"
                                        default="Assignment"/>
                                    <span class="required-indicator">*</span>
                                </th>
                                <th data-idx="5" class="col-md-1" data-field="createdBy"><g:message
                                        code="product.assignment.label.user.id"
                                        default="User ID"/>
                                </th>
                                <th data-idx="6" class="col-md-2" data-field="workflowGroup"><g:message
                                        code="product.assignment.label.workflow.group"
                                        default="Workflow Group"/>
                                </th>
                                <th data-idx="7" class="col-md-2 sorting_disabled" data-field="action"></th>
                            </g:if>
                            <g:else>
                    ...
                    <tr role="row" class="productAssignmentTable_row">
                        ...
                        <g:if test="${isProductView}">
                            <td class="col-ag">
                                <g:render template="/includes/widgets/alert_group"/>
                            </td>
                        </g:if>
