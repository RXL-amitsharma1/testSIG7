    ...
    <div class="modal-dialog modal-lg product-group-modal-dialog" style="max-width: 800px;display:block" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body container-fluid">
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <div class="form-group description-wrapper">
                                ...
                                <g:textArea rows="5" cols="3" id="descriptionProductGroupAssessment" name="descriptionProductGroupAssessment" maxlength="8000" style="height: 110px;" value="" class="form-control "/>
                            </div>
                        </div>
                    </div>
                ...
                <g:hiddenField name="productGroupIsWhoDrug" id="productGroupIsWhoDrugAssessment" value=""/>
            </div>
