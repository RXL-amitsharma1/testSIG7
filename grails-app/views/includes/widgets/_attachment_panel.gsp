...
<div class="attachments">
    ...
    <g:if test="${source == 'detail' || source == 'edit'}">
        ...
        <a class="btn btn-primary ${buttonClass}" style="margin-bottom: 10px;" href="#myModal" data-toggle="modal">Add File</a>
    </g:if>

    <table id="attachment-table" class="table table-striped pv-list-table dataTable no-footer" style="width: 100%">
        <thead>
        <tr>
