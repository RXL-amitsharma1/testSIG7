                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            <div class="form-group description-wrapper">
                                ...
                                <g:textArea rows="5" cols="3" name="eventGroupDescription" id="eventGroupDescriptionAssessment" class="eventGroupDescriptionAssesment form-control" maxlength="8000" style="height: 110px"/>
                            </div>
                        </div>
