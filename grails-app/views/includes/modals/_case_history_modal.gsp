    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                ...
                <input type="hidden" id="actualCaseNumber" />
                <input type="hidden" id="actualProductFamily"/>
                        ...
                        <tr>
                            ...
                            <th>
                                <g:if test="${!isFaers && !isVaers && !isVigibase && !isJader}">
                                    <g:if test="${columnLabelMap && columnLabelMap.containsKey('caseNumber')}">
                                ...
                                <g:else>
                                    <g:message
                                            code="${isFaers || isVaers || isVigibase ? 'app.label.qualitative.details.column.caseNumber.faers' : 'app.label.qualitative.details.column.caseNumber'}"/>
                                </g:else>
                            </th>
