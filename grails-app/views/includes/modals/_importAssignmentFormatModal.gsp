    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>- Order for columns are Alert Group, Products, Product Hierarchy, Assignment, Workflow Group, Import</div>
                ...
                <table id="importAssignmentFormatTable" class="row-border hover simple-alert-table" width="100%">
                    <thead>
                    <tr>
                        <th class="col-md-2">Alert Group</th>
                    ...
                    <tbody>
                    <td class="col-md-2">All Users</td>
                ...
                <br>
                <div>**The Alert Group field is intended solely for Health Authority setups. Please leave this field blank for other configurations.</div>
            </div>
