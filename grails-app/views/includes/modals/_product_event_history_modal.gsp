    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <label class="modal-title"><g:message code="app.label.peHistory.modal.title"/>  : <span id="productName" class="word-wrap-break-word"></span>-<span
                        id="eventName" class="word-wrap-break-word"></span>
                </label>
