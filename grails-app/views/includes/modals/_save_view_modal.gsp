        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="buttons edit_buttons" style="display: none;">
                    <button type="button" id="editViewButton" class="btn btn-primary edit-view">
                        Save
                    </button>
                    <button type="button" id="deleteViewButton" class="btn btn-primary delete-view" data-dismiss="modal">
                        Delete
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Cancel
...
<script>
    $(function () {
            ...
            $.ajax({
                ...
                .done(function (data) {
                    if (data.success) {
                        ...
                        var isCaseSeriesGeneratingIndex = pageURL.indexOf('isCaseSeriesGenerating');
                        if (isCaseSeriesGeneratingIndex != -1) {
                            var isCaseSeriesGeneratingEndIndex = pageURL.indexOf('&', isCaseSeriesGeneratingIndex);
                            if (isCaseSeriesGeneratingEndIndex == -1) {
                                pageURL = pageURL.slice(0, isCaseSeriesGeneratingIndex) + 'isCaseSeriesGenerating=false';
                            } else {
                                pageURL = pageURL.slice(0, isCaseSeriesGeneratingIndex) + 'isCaseSeriesGenerating=false' + pageURL.slice(isCaseSeriesGeneratingEndIndex);
                            }
                        } else {
                            pageURL += '&isCaseSeriesGenerating=false';
                        }
        ...
        $('#editViewButton').on('click', function () {
            $(this).prop("disabled", true);
