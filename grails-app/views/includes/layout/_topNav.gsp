...
function clearAndSetDefaultValueInSessionStorage() {
    ...
    sessionStorage.removeItem("alertDashboard");
    var keys = Object.keys(sessionStorage);
    $.each(keys, function (index, key) {
        if (key.includes('aca_filterMap_')) {
...
<div class="topbar" style="z-index: 1000 !important;">
    ...
    <div class="pull-left">
        <button class="button-menu-mobile open-left waves-effect" accesskey="b" data-toggle="tooltip" title="Main Menu">
            <g:if test="${hideMenu==false}"><i class="mdi mdi-menu"></i></g:if>
        </button>
...
<ul>
        ...
        ">
                        <li class="has_sub">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="md md-alert"></i><span><g:message
        ...
        code="app.aggregated.case.review"/></g:link></li>
                                ...
                                <g:if test="${true}">
                                    <li>
                                        <g:link controller="dataMiningResult" action="index">
                                            <g:message code="app.label.adhoc.dataMiningResult"/>
                                        </g:link>
                                    </li>
                                </g:if>
                            </ul>
        ...
        roles="ROLE_AD_HOC_CRUD, ROLE_SINGLE_CASE_CONFIGURATION, ROLE_AGGREGATE_CASE_CONFIGURATION,
                        ...
                        <li class="has_sub">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="md md-settings-box"></i><span><g:message
        ...
        roles="ROLE_SINGLE_CASE_CONFIGURATION, ROLE_AGGREGATE_CASE_CONFIGURATION,
                    ...
                    <sec:ifAnyGranted roles="ROLE_QUERY_CRUD">
                        <li class="has_sub">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="md md-filter-variant"></i>
                    ...
                    <li class="has_sub">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="md md-calendar"></i><span><g:message code="app.signal.event.title"/><span class="menu-arrow"></span></span>
                        </a>
                        <ul class="list-unstyled">
                            <li>
