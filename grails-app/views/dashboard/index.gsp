...
<head>
    ...
    <asset:javascript src="vendorUi/highcharts/highcharts-10.3.3/modules/no-data-to-display.js"/>
    <asset:javascript src="vendorUi/fullcalendar.min.js"/>
    <asset:javascript src="vendorUi/gridstack/gridstack-all.js"/>
%{--
...
--}%
    ...
    <style>
        .highcharts-stack-labels .highcharts-text-outline {
                            ...
                            <div id="my-aggregate" class="${grailsApplication.config.signal.evdas.enabled ? 'col-sm-2' : 'col-sm-2 width-20per'}">
                                <div class="widget-simple-chart text-center card-box pv-inner-shadow-box">
                                    ...
                                    <h1 class="text-red p-t-0">
                                        <a href="${aggDataUrl}?callingScreen=dashboard" onclick="return checkCount(this)" class="text-red">
