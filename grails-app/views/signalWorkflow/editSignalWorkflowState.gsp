...
<body>
    <rx:container title="Edit Signal Workflow State">
        ...
        <div class="">
            <g:form action="saveWorkflowState" method="post" name="updateForm">
                ...
                <sec:ifAnyGranted roles="ROLE_CONFIGURATION_CRUD">
                    <div class="row form-group">
                        <div class="col-lg-5">
                            <span class="button disable-check" data-action="updateWorkflowState"><g:actionSubmit id="updateWorkflowState"
                            ...
                            <span class="button"><g:actionSubmit id="cancelState" class="btn pv-btn-grey" action="signalWorkflowList"
