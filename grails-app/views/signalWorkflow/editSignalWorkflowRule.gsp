...
<body>
    <rx:container title="Edit Signal Workflow Rule">
        ...
        <div class="">
            <g:form action="saveWorkflowRule" method="post" name="updateWorkFlowRuleForm">
                ...
                <sec:ifAnyGranted roles="ROLE_CONFIGURATION_CRUD">
                    <div class="row form-group">
                        <div class="col-lg-5">
                                <span class="button disable-check" data-action="updateWorkflowRule"><g:actionSubmit id="updateWorkflowRule" class="updateWorkflowRule btn btn-primary" action="updateWorkflowRule"
                                                                                                        value="${message(code: 'default.button.update.label', 'default': 'Update')}"/></span>
                                <span class="button disable-check" data-action="deleteWorkflowRule"><g:actionSubmit id="deleteWorkflowRule" class="deleteWorkflowRule btn pv-btn-grey" action="deleteWorkflowRule"
