    ...
    <!------------------=================--------------Abstract view code started-----------================----------------------->
           <span class="m-r-10 grid-pin collapse" id="ic-abstractview">
               <label for="detailed-view-checkbox">
                   <g:checkBox name="detailed-view-checkbox" checked="${isAbstractView}" accesskey="v"/>
...
<div class="dropdown grid-icon ico-menu pull-right" id="reportIconMenu">
    ...
    <ul class="dropdown-menu ul-ddm">
        ...
        <li class="li-pin-width">
            <a class="test text-left-prop ul-ddm-hide m-l-5 abstract-menu" href="#" data-checked ="${isAbstractView}">
                <g:checkBox style="position:relative; bottom:0.25rem;" name="detailed-view-checkbox" checked="${isAbstractView}" accesskey="v"/>
...
%{--                    PVS-55163 This code ensure Column level filtering available for both latest and archived alert of literature alert.--}%
        <li class="li-pin-width">
...
<!-------------------------------------list menu ended---------------------------------------------------------------------------------------------->
    ...
    <div class="row">
        <div class="col-md-12">
            <table id="alertsDetailsTable" class="auto-scale table table-striped pv-list-table dataTable no-footer DTFC_Cloned">
                <thead>
                <tr id="literatureDetailsTableRow">
                    ...
                    <g:if test="${selectedDatasource == 'pubmed'}">
                        <th data-field="citation">
                            <div class="th-label" data-field="citation">Citation</div>
                        </th>
                        <th data-field="publicationYear">
                            <div class="th-label" data-field="publicationYear">Publication Year</div>
                        </th>
                    </g:if>

                    <g:if test="${selectedDatasource == 'embase'}">
                        <th data-field="affiliationOrganization">
                            <div class="th-label" data-field="affiliationOrganization">
                                <g:message code="app.label.literature.details.embase.column.affiliationOrganization"/>
                            </div>
                        </th>
                        <th data-field="sourceTitle">
                            <div class="th-label" data-field="sourceTitle">
                                <g:message code="app.label.literature.details.embase.column.sourceTitle"/>
                            </div>
                        </th>
                        <th data-field="issn">
                            <div class="th-label" data-field="issn">
                                <g:message code="app.label.literature.details.embase.column.issn"/>
                            </div>
                        </th>
                        <th data-field="sourceLink">
                            <div class="th-label" data-field="sourceLink">
                                <g:message code="app.label.literature.details.embase.column.sourceLink"/>
                            </div>
                        </th>
                        <th data-field="publicationYear">
                            <div class="th-label" data-field="publicationYear">
                                <g:message code="app.label.literature.details.embase.column.publicationYear"/>
                            </div>
                        </th>
                        <th data-field="chemicalName">
                            <div class="th-label" data-field="chemicalName">
                                <g:message code="app.label.literature.details.embase.column.chemicalName"/>
                            </div>
                        </th>
                        <th data-field="casRegistryNumber">
                            <div class="th-label" data-field="casRegistryNumber">
                                <g:message code="app.label.literature.details.embase.column.casRegistryNumber"/>
                            </div>
                        </th>
                        <th data-field="manufacturer">
                            <div class="th-label" data-field="manufacturer">
                                <g:message code="app.label.literature.details.embase.column.manufacturer"/>
                            </div>
                        </th>
                        <th data-field="tradeName">
                            <div class="th-label" data-field="tradeName">
                                <g:message code="app.label.literature.details.embase.column.tradeName"/>
                            </div>
                        </th>
                        <th data-field="tradeItemManufacturer">
                            <div class="th-label" data-field="tradeItemManufacturer">
                                <g:message code="app.label.literature.details.embase.column.tradeItemManufacturer"/>
                            </div>
                        </th>
                        <th data-field="externalSource">
                            <div class="th-label" data-field="externalSource">
                                <g:message code="app.label.literature.details.embase.column.externalSource"/>
                            </div>
                        </th>
                        <th data-field="publisherEmail">
                            <div class="th-label" data-field="publisherEmail">
                                <g:message code="app.label.literature.details.embase.column.publisherEmail"/>
                            </div>
                        </th>
                        <th data-field="enzymeCommissionNumber">
                            <div class="th-label" data-field="enzymeCommissionNumber">
                                <g:message code="app.label.literature.details.embase.column.enzymeCommissionNumber"/>
                            </div>
                        </th>
                        <th data-field="digitalObjectIdentifier">
                            <div class="th-label" data-field="digitalObjectIdentifier">
                                <g:message code="app.label.literature.details.embase.column.digitalObjectIdentifier"/>
                            </div>
                        </th>
                    </g:if>
                </tr>
