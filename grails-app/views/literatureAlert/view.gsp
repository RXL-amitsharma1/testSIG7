<%@ page import="com.rxlogix.Constants;grails.converters.JSON; com.rxlogix.enums.DictionaryTypeEnum; com.rxlogix.enums.DateRangeEnum; com.rxlogix.util.DateUtil; com.rxlogix.config.ExecutedConfiguration; com.rxlogix.util.ViewHelper; com.rxlogix.enums.DateRangeTypeCaseEnum;  com.rxlogix.config.DateRangeValue" %>
...
<g:if test="${isExecutedCase}">
    <g:set var="title" value="${message(code: "app.label.alert.criteria")}"/>
</g:if>
<g:else>
...
<rx:container title="${title}">
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div>${configurationInstance.selectedDatasource?.equalsIgnoreCase(Constants.DataSource.PUB_MED) ? Constants.DataSource.PUB_MED : Constants.LiteratureFields.EMBASE}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <g:if test="${configurationInstance.selectedDatasource == 'embase'}">
                <div class="col-xs-4">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div>
                                <g:if test="${configurationInstance?.literatureQueryName}">
                                    <div>
                                        <g:link controller="query" action="view" target="blank"
                                                id="${configurationInstance.literatureQueryId}">${configurationInstance.literatureQueryName}</g:link>
                                    </div>
                                </g:if>
                                <g:else>
