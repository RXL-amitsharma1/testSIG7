...
<%@ page import="com.rxlogix.enums.EvaluateCaseDateEnum; org.springframework.security.core.context.SecurityContextHolder" %>
<html>
<head>
    ...
    <div class="container-fluid">
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-3">
                        ...
                        <g:render template= "/aggregateCaseAlert/includes/displayProduct"/>
                    ...
                    <div class="col-xs-3">
                        ...
                        <g:if test="${configurationInstance.selectedDatasource.contains(Constants.DataSource.PVA)}">
                            <div class="row">
                                <div class="col-xs-12">
                                    <label><g:message code="import.configuration.label.includeWHODrugs"
                                                      default="Include WHO Drugs"/></label>

                                    <div id="includeWHODrugs"></div>
                                    <g:formatBoolean boolean="${configurationInstance.includeWHODrugs}"
                                                     true="${message(code: "default.button.yes.label")}"
                                                     false="${message(code: "default.button.no.label")}"/>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label><g:message code="app.label.configuration.study.cases"/></label>
                                <div>
                                    <g:formatBoolean boolean="${configurationInstance.studyCases}"
                                                     true="${message(code: "default.button.yes.label")}"
                                                     false="${message(code: "default.button.no.label")}"/>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-3">
                        <g:if test = "${SecurityContextHolder.context.authentication.authorities*.authority.contains('ROLE_DATA_MINING_ADVANCED_RUNS')}">
                            <div class="row">
                                <div class="col-xs-12">
                                    <label><g:message code="app.label.MastertemplateAlert"/></label>

                                    <div>
                                        <g:formatBoolean boolean="${configurationInstance.isMasterTemplateAlert}"
                                                         true="Yes"
                                                         false="No"/>
                                    </div>
                                </div>
                    ...
                    <g:render template="/includes/widgets/includeStudyCasesConfiguration" model="[configurationInstance: configurationInstance]"/>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                ...
                %{-- Removed bug/PVS-58115- part for product type as it comes twice  --}%
    ...
    <g:if test="${templateQueries || configurationInstance?.spotfireSettings}">
        ...
        <div class="row">
            ...
            <div class="col-xs-3 word-wrap-break-word">
                ...
                <div><g:showSharedWithNameWithReadOnly bean="${configurationInstance}"/></div>
            </div>
