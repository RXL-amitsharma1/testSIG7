    ...
    <div class="rxmain-container-inner">
        ...
        <div class="rxmain-container-content">
            <g:render template="includes/alertCriteria"
                      model="[configurationInstance: configurationInstance, action: action, sMQList: sMQList, templateList: templateList, productGroupList: productGroupList, isPVCM:isPVCM, productHierarchy:productHierarchy, eventHierarchy:eventHierarchy, configurationInstanceEventHierarchy:configurationInstanceEventHierarchy,configurationInstancePrdHierarchy:configurationInstancePrdHierarchy]"/>
        </div>
    </div>
</div>
