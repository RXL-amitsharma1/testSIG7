...
<div class="panel-group">
    ...
    <g:render template="includes/alertConfiguration" model="[configurationInstance: configurationInstance,action:action, sMQList: sMQList, templateList: templateList, productGroupList: productGroupList, isPVCM: isPVCM,productHierarchy:productHierarchy, eventHierarchy:eventHierarchy, configurationInstanceEventHierarchy:configurationInstanceEventHierarchy,configurationInstancePrdHierarchy:configurationInstancePrdHierarchy]"/>
