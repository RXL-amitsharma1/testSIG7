...
<g:set var="alertService" bean="alertService"/>
<head>
            ...
            <g:if test="${callingScreen == Constants.Commons.REVIEW}">
                ...
                <span class="pos-rel drange" style="float: none;">
                    <span tabindex="0" class="saveViewPanel grid-menu-tooltip" accesskey="s" aria-expanded="true"
                        ...
                        <g:set var="encodedExecutedConfigId" value="${configurationService?.encodeId(executedConfigId)}"/>
                        <a href="${createLink(controller: 'aggregateCaseAlert', action: 'viewExecutedConfig', id: encodedExecutedConfigId) ?: '#'}"
