...
<head>
    ...
    <g:javascript>
        ...
        var angularDetailsUrl = "${angularAlertUrl}";
...
<rx:container title="${message(code: message(code: "app.aggregated.case.review"))}" options="${true}">
    ...
    <div class="row">
        <div class="col-lg-12">
            <table id="simpleCaseAlerts" class="table table-striped pv-list-table dataTable no-footer simple-alert-table" width="100%">
                <thead>
                <tr>
...
<g:form name="shareForm" controller="${controller}">
...
<script>
    $(function(){
        $('#edit').on('click', function(){
            ...
            $('#shareForm').attr("action","/signal/aggregateCaseAlert/editShare")
            $('#shareForm').submit();
        })
    })
