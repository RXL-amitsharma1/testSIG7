    ...
    <div class="rxmain-container-inner">
        ...
        <div class="rxmain-container-row rxmain-container-header">
            <label class="rxmain-container-header-label click">
                <g:message code="app.label.business.configuration.ruleInformation" />
            </label>
        </div>

        <div class="rxmain-container-content">

            <g:form controller="businessConfiguration" action="saveRule" name="businessConfigurationForm">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <g:submitButton name="saveBusinessConfigButton" class="btn btn-primary" value="Create"/>
