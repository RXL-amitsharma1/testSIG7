...
<div class="row" >
    ...
    <div class="col-md-2">
        <input type="text" name="ruleName" id="ruleName" class="form-control required" value="${ruleInformation?.ruleName}" maxlength="255" required="required"/>
    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="row" id="attach-signal-container"
                ...
                <div class="col-md-6">
                    ...
                    <g:select name="signal" id="signal" class="form-control select2" from="${signalList}" optionKey="id" optionValue="name" value="${ruleInformation?.signal}" noSelection="['': '-Select Signal-']"/>
                </div>
            </div>
