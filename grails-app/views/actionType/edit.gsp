    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            ...
            <g:form method="POST" name="editForm">
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit id="save" class="save btn btn-primary" action="update" value="${message(code: 'default.button.update.label', 'default': 'Update')}"/></span>
                    <span class="button"><g:actionSubmit id="delete" class="delete btn pv-btn-dark-grey" action="delete" value="${message(code: 'default.button.delete.label', 'default': 'Delete')}"
...
<script>
    $(function(){
        $('#save').on('click',function(){
            ...
            $('#editForm').attr('action',"/signal/actionType/update");
            $('#editForm').submit();
        })
    })
</script>
