...
<script>
    $(function(){
        $('#submitEditForm').on('click',function(){
            ...
            $('#actionTypeEditForm').attr('action',"/signal/actionType/edit");
            $('#actionTypeEditForm').submit();
        })
    })
</script>
<rx:container title="Show ActionType">
    ...
    <div class="body">
        <g:form name="actionTypeEditForm">
                ...
                <div class="row">
                    <div class="dialog col-md-6 col-xs-12">
                        <div class="buttons m-t-10">
                            <span class="button"><g:actionSubmit id="submitEditForm" class="edit btn btn-primary" action="edit"
                                                                 value="${message(code: 'default.button.edit.label', 'default': 'Edit')}"/></span>
                            <span class="button"><g:actionSubmit id="delete" class="delete btn pv-btn-dark-grey" action="delete"
