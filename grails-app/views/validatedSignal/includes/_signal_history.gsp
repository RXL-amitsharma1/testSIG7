...
<div class="container-fluid attachments">
    <table id="signal-history-table" class="table table-striped pv-list-table dataTable no-footer">
        <thead>
        <tr>
            <th class="sorting_disabled"><g:message code="signal.history.label.from.status"/></th>
                <th class="sorting_disabled"><g:message code="signal.history.label.to.status"/><span
        ...
        <g:if test="${signalHistoryList}">
            <g:each status="i" in="${signalHistoryList}" var="signalHistory">
                <tr role="row" class="${(i % 2) == 0 ? 'odd' : 'even'} signalHistoryRow">
                    ...
                    <td class="col-md-2">
                        <input type="text" class="form-control workflow-from-state" value="${signalHistory?.fromSignalStatus}" maxlength="255" disabled/>
                    </td>
                    ...
                    <td class="col-md-3">
                        <div class="textarea-ext">
                            <g:textArea name="comment${i}" class="form-control comment ellipsis-comment" style="min-height: 25px" rows="1"
                        ...
                        <div class="fuelux">
                            <div class="datepicker toolbarInline ${signalHistory.signalStatus!=com.rxlogix.Constants.WorkFlowLog.DUE_DATE? 'historyDatePicker':'' } ">
                                <div class="input-group">
                                    <g:if test="${signalHistory.isAutoPopulate || signalHistory.performedBy == Constants.Commons.SYSTEM }">
        ...
        <g:else>
            <tr role="row" class="odd signalHistoryRow">
                <td class="col-md-2">
                    <input type="text" class="form-control workflow-from-state" name="fromSignalStatus" value="${signalHistory?.fromSignalStatus}" maxlength="255"/>
                </td>
                <td class="col-md-2">
                    <g:select name="signalStatus" class="form-control status"
                ...
                <td class="col-md-3">
                    <div class="textarea-ext">
                        <textarea name="descText"type="text" class="form-control comment ellipsis-comment" style="min-height: 25px" rows="1" maxlength="8000"></textarea>
                        <a class="btn-text-ext openStatusComment" href="" tabindex="0" title="Open in extended form">
                            <i class="mdi mdi-arrow-expand font-20 blue-1"></i></a>
                    </div>
                </td>
