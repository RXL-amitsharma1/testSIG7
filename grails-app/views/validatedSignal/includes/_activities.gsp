...
<div class="rxmain-container panel-group">
    <div class="panel panel-default rxmain-container rxmain-container-top">
        <div class="rxmain-container-row rxmain-container-header-label panel-heading pv-sec-heading">
            <div class="row">
                <div class="col-md-7">
                    <a data-toggle="collapse" id="accordion-pvs-analysis-toggle" data-parent="#accordion-pvs-analysis" href="#signalDiv"
                ...
                <div class="col-md-5">
                    ...
                    <span class="pull-right">
                        <a href="javascript:void(0);" class="ic-sm activity-search-btn" title="Search">
        ...
        <div id="signalDiv" class="panel-collapse rxmain-container-content rxmain-container-show collapse in"
            ...
            <div id="validatedSignalTableContainer" class="pv-scrollable-dt">
                <table id="signalActivityTable" class="table table-striped pv-list-table dataTable no-footer" width="100%">
                    <thead>
                    <tr>
                        <th class=""><g:message code="app.label.activity.type"/></th>
                        <th class="col-min-500 col-max-500"><g:message code="app.label.description"/></th>
