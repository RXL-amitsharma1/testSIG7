    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <g:render template="includes/productDictionaryTemplateAssessment"
                          model="[column_names: PVDictionaryConfig.ProductConfig.columns, views: PVDictionaryConfig.ProductConfig.views.sort{it.index}, filters: PVDictionaryConfig.ProductConfig.filters.sort{it.index}, productColumnCode: PVDictionaryConfig.ProductColumnCode, multiIngredientValue: multiIngredientValue, isPVCM: isPVCM]"/>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default addAllProductsAssessment" accesskey="#"><g:message
