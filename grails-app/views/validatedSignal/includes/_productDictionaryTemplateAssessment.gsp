...
<div class="row" style="margin-top: 1%">
    ...
    <div class="col-xs-5 padding-md-bottom" id="who_dr_checkbox_div_assessment" >
        <div class="checkbox checkbox-primary">
            <g:checkBox id="who_dr_checkbox_assessment" name="who_dr_checkbox_assessment" value="${isWhoDrug}"/>
            <label for="who_dr_checkbox_assessment" tabindex="0">
...
#who_dr_checkbox_div_assessment{
    width: 180px;
}
</style>
