...
<div class="panel-collapse rxmain-container-content pv-scrollable-dt rxmain-container-show collapse in" id="accordion-pvs-rmms">
    <table id="signal-rmms-table" class="table table-striped pv-list-table dataTable no-footer">
        <thead>
        <style>
        .webui-popover.top>.webui-arrow, .webui-popover.top-right>.webui-arrow, .webui-popover.top-left>.webui-arrow {
            display: none;
        }
        #signal-rmms-table_wrapper.dt-container .dt-layout-row.dt-layout-table {
            overflow: unset;
        }

        #signal-communication-table_wrapper.dt-container .dt-layout-row.dt-layout-table {
            overflow: unset;
        }
