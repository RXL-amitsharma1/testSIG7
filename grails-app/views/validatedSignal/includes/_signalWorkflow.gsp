...
<script>
    ...
    $(function () {
        ...
        $(".sharedWithPartners").on('click', function () {
        ...
        $(".showWorkflowHistory").on('click', function () {
        ...
        $("form#attachmentForm").off('submit').on('submit', function () {
            ...
            $.ajax({
                ...
                .done(function () {
                    $('#myModal').modal('hide');
                    $.Notification.notify('success', 'top right', "Success", $.i18n._('attachmentAddedSuccess'), {autoHideDelay: 5000});
        ...
        $("form#referenceForm").off('submit').on('submit', function () {
            $(this).find('#description').val(encodeToHTML($(this).find('#description').val()));
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $.Notification.notify('success', 'top right', "Success", $.i18n._('referenceAddedSuccess'), {autoHideDelay: 5000});
            ...
            fnDrawCallback: function () {
                ...
                $('.remove-attachment').on('click', function (e) {
                    ...
                    $.ajax({
                        ...
                        .done(function () {
                            $('#attachment-table').DataTable().ajax.reload();
                            $.Notification.notify('success', 'top right', "Success", $.i18n._('attachmentRemovedSuccess'), {autoHideDelay: 5000});
                        })
                        .fail(function () {
                            $.Notification.notify('error', 'top right', "Error", $.i18n._('attachmentDeleteFailed'), {autoHideDelay: 5000});
                        })
                })
            },
            "aoColumns": [
        ...
        $('.manageWorkflowStateHeader').on('change', function () {
            if(possibleDispositions[workflowStateStart].length !== 0 && $.inArray($('.dispositionId').attr("data-id"), possibleDispositions[workflowStateStart])  === -1) {
                $.Notification.notify('warning', 'top right', "Warning",  "The decision for the signal has not been completed yet. Please change the disposition before moving to the next signal workflow state.", {autoHideDelay: 5000});
            } else {
                $.ajax({
                    ...
                    .done(function (response) {
                         if (response.status) {
                            $.Notification.notify('success', 'top right', "Success", $.i18n._('workflowState.success'), {autoHideDelay: 5000});
        ...
        $('#assignedToActionAndWorkflow').on('change', function () {
                $.ajax({
                    url: saveAssignedTo,
                    data: {
                    ...
                    .done(function (response) {
                        if (response.status) {
                            ...
                            $.Notification.notify('success', 'top right', "Success", $.i18n._('assignedTo.success'), {autoHideDelay: 5000});
