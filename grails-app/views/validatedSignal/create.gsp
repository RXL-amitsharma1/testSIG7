...
<head>
    ...
    <g:javascript>
        ...
        var saveSignalUrl = "${createLink(controller: 'validatedSignal', action: 'save')}";
        var disabledValues = {
...
<g:form method="post" autocomplete="off" name="saveSignal">
    ...
    <div class="m-t-15 text-right">
        <input class="btn primaryButton pv-btn-grey" id="cancelSignalBtn" tabindex="0" accesskey="r" type="button"
               value="${message(code: 'default.button.cancel.label')}"/>
        <input class="btn primaryButton btn-primary" id="saveSignalBtn" tabindex="0" accesskey="r" type="submit"
