...
<head>
    ...
    <title>Important Safety Issues</title>
...
<sec:ifAnyGranted roles="ROLE_CONFIGURATION_CRUD">
    <g:render template="/emergingIssue/add_alert_list"
              model="[emergingIusseList: emergingIusseList, controller: controllerName, callingScreen: callingScreen]"/>
    <g:render template="/configuration/copyPasteModal"/>
</sec:ifAnyGranted>
<g:render template="/emergingIssue/show_alert_list" model="[emergingIusseList: emergingIusseList]"/>
