                        ...
                        <span  tabindex="0" class="dropdown-toggle saveViewPanel grid-menu-tooltip dropbtn" data-title="Save View" data-toggle="dropdown" accesskey="s" title="${message(code: 'app.label.exportTo')}">
                            ...
                            <ul class="dropdown-menu save-list dropdown-content dropdown-menu-right ddm-padding">
                                ...
                                <li><g:link controller="adHocAlert" action="exportReport" class="m-r-30"
                                            params="${[outputFormat: ReportFormat.DOCX,id : id, 'viewInstance.id': viewId]}">
                                    <img src="/signal/assets/word-icon.png" class="m-r-10" height="16" width="16" /><g:message code="save.as.word" />
                                </g:link>
                                </li>
                                <li><g:link controller="adHocAlert" action="exportReport" class="m-r-30"
                                            params="${[outputFormat: ReportFormat.XLSX,id : id, 'viewInstance.id': viewId]}">
                                    <img src="/signal/assets/excel.gif" class="m-r-10" height="16" width="16" /><g:message code="save.as.excel" />
                                </g:link></li>
                                <li><g:link controller="adHocAlert" action="exportReport" class="m-r-30"
                                            params="${[outputFormat: ReportFormat.PDF,id : id, 'viewInstance.id': viewId]}">
...
<!-------------------------------------list menu ended---------------------------------------------------------------------------------------------->
    ...
    <div class="row">
        <table id="alertsDetailsTable" class="auto-scale row-border no-shadow hover table-striped" width="100%">
            <thead>
            <tr id="alertsDetailsTableRow">
                ...
                <g:if test="${isPriorityEnabled && labelMap['priority']}">
                    <th data-idx="3" data-field="priority"><div class="th-label">${labelMap['priority']}</div></th>
                </g:if>
                <g:if test="${labelMap['name']}">
                    <th data-idx="4" data-field="name"><div class="th-label">${labelMap['name']}</div></th>
                </g:if>
                <g:if test="${labelMap['productSelection']}">
                    <th data-idx="5" data-field="productSelection"><div class="th-label">${labelMap['productSelection']}</div></th>
                </g:if>
                <g:if test="${labelMap['eventSelection']}">
                    <th data-idx="6" data-field="eventSelection"><div class="th-label">${labelMap['eventSelection']}</div></th>
                </g:if>
                <g:if test="${labelMap['issueTracked']}">
                    <th data-idx="7" data-field="issueTracked"><div class="th-label">${labelMap['issueTracked']}</div></th>
                </g:if>
                <g:if test="${labelMap['numOfIcsrs']}">
                    <th data-idx="8" data-field="numOfIcsrs"><div class="th-label">${labelMap['numOfIcsrs']}</div></th>
                </g:if>
                <g:if test="${labelMap['initDataSrc']}">
                    <th data-idx="9" data-field="initDataSrc"><div class="th-label">${labelMap['initDataSrc']}</div></th>
                </g:if>
                <g:if test="${labelMap['signalsAndTopics']}">
                    <th data-idx="11" data-field="signalsAndTopics"><div class="th-label">${labelMap['signalsAndTopics']}</div></th>
                </g:if>
                <g:if test="${labelMap['currentDisposition']}">
                    <th data-idx="16" data-field="currentDisposition"><div class="th-label">${labelMap['currentDisposition']}</div></th>
                </g:if>
                <g:if test="${labelMap['disposition']}">
                    <th data-idx="12" data-field="disposition"><div class="th-label">${labelMap['disposition']}</div></th>
                </g:if>
                <g:if test="${labelMap['assignedTo']}">
                    <th data-idx="13" data-field="assignedTo"><div class="th-label">${labelMap['assignedTo']}</div></th>
                </g:if>
                <g:if test="${labelMap['detectedDate']}">
                    <th data-idx="14" data-field="detectedDate"><div class="th-label">${labelMap['detectedDate']}</div></th>
                </g:if>
                <g:if test="${labelMap['dueIn']}">
                    <th data-idx="15" data-field="dueIn"><div class="th-label">${labelMap['dueIn']}</div></th>
                </g:if>
            </tr>
            </thead>
        </table>
