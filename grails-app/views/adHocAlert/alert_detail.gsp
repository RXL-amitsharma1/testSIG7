...
<div id="adhoc-detail">
    ...
    <rx:container title="${sectionLabelMap['alertdetails']}">
    ...
    <div class="row">
        <div class="col-md-12">
            <rx:container title="${sectionLabelMap['workflow']}">
...
<g:if test="${filteredMap['documentManagement']?.enabled == true}" >
    <rx:container title="${filteredMap['documentManagement']?.section_label}">
    ...
    <div class="panel panel-default rxmain-container rxmain-container-top">
        ...
        <div class="rxmain-container-content rxmain-container-show">
            <div class="col-md-12">
                <table id="activity_list" class="table table-striped pv-list-table hover no-shadow" width="100%">
                    <thead>
                    <tr>
