...
<head>
    ...
    <g:javascript>
        ...
        var listConfigUrl = "${createLink(controller: 'adHocAlert', action: 'list', params: [callingScreen: params.callingScreen, 'viewInstanceId': viewId])}";
        ...
        var labelsMap = '${groovy.json.JsonOutput.toJson(labelMap)}';
    ...
    <style>
     ...
     .pos-ab.comment{ bottom:-1px; right:-6px; }
...
<div class="pv-tab">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="details">
            <g:render template="includes/details_tab" bean="${alert}" model="[viewId:viewId,adhocHelpMap:adhocHelpMap, labelMap:labelMap]"/>
        </div>
    </div>
