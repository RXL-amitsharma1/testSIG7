...
<script>
    $(function () {
        ...
        $('.action-value').on('change', function () {
            var $modal;
        ...
        $('#actionStatus').on('change', function () {
            if ($(this).val() === 'Closed') {
...
<div class="col-lg-12 action">
    <div class="row">
        <div class="col-lg-4 action-type-list">
            ...
            <g:select style="width: 100%" class="form-control select2 typeId" name="type.id" id=""
        ...
        <div class="col-lg-4">
            ...
            <g:select style="width: 100%" class="form-control action-value select2" name="config.id" id=""
        ...
        <div class="col-lg-4 hidden meeting-list">
            ...
            <g:select style="width: 100%" class="form-control" name="meeting.id" id="meetingElement"
